...
export class WyvernExchangeV1 extends ethereum.SmartContract {
  static bind(address: Address): WyvernExchangeV1 {
    return new WyvernExchangeV1("WyvernExchangeV1", address);
  }
